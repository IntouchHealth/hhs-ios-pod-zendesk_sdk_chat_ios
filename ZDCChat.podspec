Pod::Spec.new do |s|
    ...
    s.author       = 'Zendesk'
    s.source       = { :git => "https://github.com/IntouchHealth/hhs-ios-pod-zendesk_sdk_chat_ios.git", :tag => s.version.to_s }
    s.platform     = :ios, '12'
    s.requires_arc = true
    ...
    s.subspec 'UI' do |ss|
        ss.ios.vendored_frameworks = 'ZDCChat.xcframework'
        ss.preserve_paths = 'ZDCChat.xcframework'
    ...
    s.subspec 'API' do |ss|
        ...
        ss.ios.vendored_frameworks = 'ZDCChatAPI.xcframework'
        ss.preserve_paths = 'ZDCChatAPI.xcframework'
        ss.xcconfig = { 'FRAMEWORK_SEARCH_PATHS' => '$(inherited)', 'CLANG_ALLOW_NON_MODULAR_INCLUDES_IN_FRAMEWORK_MODULES' => 'YES' }
    end
end
